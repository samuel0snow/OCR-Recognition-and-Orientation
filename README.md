...
用户输入图片和关键词，程序通过OCR技术识别图片中是否包含关键词并且定位关键词出现的位置。<br>
Users input an image and keywords, and the program uses OCR technology to detect the presence of the keywords in the image and locate their positions.
